...
public class RaiseRockTerraformer extends ActionMaster {

    private final TilePos targetedTile;
    private final boolean onSurface;

    static WeakHashMap<Action, RaiseRockTerraformer> actionDataWeakHashMap = new WeakHashMap<>();

    RaiseRockTerraformer(Action action, Creature performer, @Nullable Item activeTool, int usedSkill, int minSkill,
