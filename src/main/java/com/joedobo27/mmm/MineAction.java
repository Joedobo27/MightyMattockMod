...
class MineAction extends ActionMaster {

    private final TilePos targetedTile;
    private final boolean onSurface;
    private final ArrayList<Function<ActionMaster, Boolean>> failureTestFunctions;

    static WeakHashMap<Action, MineAction> actionDataWeakHashMap = new WeakHashMap<>();

    MineAction(Action action, Creature performer, @Nullable Item activeTool, int usedSkill, int minSkill,
