...
public class ClayNShards4ConcreteMod implements WurmMod, Initable, Configurable, ServerStartedListener, ItemTemplatesCreatedListener {
    ...
    public void onServerStarted() {
        if (shardNClayToConcrete) {
            ...
            try {
                simpleEntries = ReflectionUtil.getPrivateField(CreationMatrix.class,
            ...
            try {
                matrix = ReflectionUtil.getPrivateField(CreationMatrix.class,
    ...
    public void init() {
        if (useCustomSlopeMax || useCustomDepthMax) {
            ...
            CtClass ctcCaveTileBehaviour = pool.makeClass("Default");
            try {
                ctcCaveTileBehaviour = pool.get("com.wurmonline.server.behaviours.CaveTileBehaviour");
            ...
            if (useCustomDepthMax){
                ...
                /*
                //Change 729-731 in raiseRockLevel of CaveTileBehaviour to allow custom max water depth for concrete.
                ...
                */
                //</editor-fold>
                try {
                    getRaiseRockLevelIterator().insertGap(731,34);
            ...
            if (useCustomSlopeMax) {
                CtClass ctcCreationEntry = pool.makeClass("Default");
                try {
                ...
                */
                ...
                CtMethod ctmRaiseRockLevel = new CtMethod(CtClass.voidType,"default",new CtClass[]{},ctcCaveTileBehaviour);
                try {
                    ctmRaiseRockLevel = ctcCaveTileBehaviour.getMethod("raiseRockLevel",
                            "(Lcom/wurmonline/server/creatures/Creature;Lcom/wurmonline/server/items/Item;IIFLcom/wurmonline/server/behaviours/Action;)Z");
                } catch (NotFoundException e) {
                    e.printStackTrace();
                }
